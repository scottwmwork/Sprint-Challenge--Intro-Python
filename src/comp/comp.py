...
print("Ends with e:")
b = [human for human in humans if human.name[-1:] == 'D']
print(b)

# Write a list comprehension that creates a list of names of everyone
# whose name starts with any letter between 'C' and 'G' inclusive.
print("Starts between C and G, inclusive:")
c = [human for human in humans if ord(human.name[0]) >= 99 or ord(human.name[0]) <= 103]
print(c)
...
e = [human + '-' + str(human.age) for human in humans]
print(e)
